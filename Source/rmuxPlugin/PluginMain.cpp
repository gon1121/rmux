...
//============================================================================================================
class rmuxPluginClass : public IVisPlugin_cl
{
public:
  ...
  {
    return "rmuxPlugin";  // must match DLL name
  }
};

//  global plugin instance
rmuxPluginClass g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_rmuxPlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_rmuxPlugin();}
...
void rmuxPluginClass::OnInitEnginePlugin()
{
  hkvLog::Info("rmuxPluginClass:OnInitEnginePlugin()");
...
void rmuxPluginClass::OnDeInitEnginePlugin()
{
  hkvLog::Info("rmuxPluginClass:OnDeInitEnginePlugin()");
