package  {
	...
	public class AutoSkillSlot extends ActionSlot implements IGameSlot {
		
		public var coolDown:MovieClip;
		public var slotUse:MovieClip;
		public var slotIcon:Icon;
		public var disableBack:MovieClip;
		public var enableBack:MovieClip;
		
		private var _lastIconPath:String;
		
		public function AutoSkillSlot() {
			coolDown.scaleX = 3;
			coolDown.scaleY = 3;
		}
